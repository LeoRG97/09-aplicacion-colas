...
socket.on('ultimosCuatro', function(data){
    //cada vez que se actualice el array de "ultimosCuatro",
    //se actualizará el HTML de esta pantalla
...
function actualizaHTML( ultimosCuatro ) {
    //renderiza los últimos cuatro tickets atendidos en la pantalla
